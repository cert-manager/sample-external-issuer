...
// +kubebuilder:rbac:groups=sample-issuer.example.com,resources=clusterissuers,verbs=get;list;watch
// +kubebuilder:rbac:groups=sample-issuer.example.com,resources=clusterissuers/status,verbs=get;update;patch
...
func (r *ClusterIssuerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&sampleissuerv1alpha1.ClusterIssuer{}).
		Complete(r)
}
